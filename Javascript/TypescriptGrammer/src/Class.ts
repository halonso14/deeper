class ExampleClass {
    constructor(public publicMember: string, private privateMemeber: string, protected protectedMemeber: string) {}
    ...
    callMember(): void {
        ...
        console.log('*** conclusion: protected members can be called within instance ***');
    }

    test(): void {
        console.log('test() is called');
        console.log('public method:', this.getPublicMemeberByPublicMethod(), this.getPublicMemeberByPrivateMethod(), this.getPublicMemeberByProtectedMethod());
        console.log('private method:', this.getPrivateMemeberByPublicMethod(), this.getPrivateMemeberByPrivateMethod(), this.getPrivateMemeberByProtectedMethod());
        console.log('protected method:', this.getProtectedMemeberByPublicMethod(), this.getProtectedMemeberByPrivateMethod(), this.getProtectedMemeberByProtectedMethod());
        console.log('*** conclusion: protected members can be called by any methods within instance ***');
    }
}

class ExtendedExampleClass extends ExampleClass {
    constructor(public extendedPublicMember: string, private extendedPrivateMemeber: string, protected extendedProtectedMemeber: string) {
    ...
    callSuperMember(): void {
        ...
        console.log('*** conclusion: members from super can be called only by methods ***');
    }

    testSuper(): void {
        console.log('testSuper() is called');
        console.log('public method:', super.getPublicMemeberByPublicMethod(), super.getPublicMemeberByProtectedMethod());
        console.log('private method:', super.getPrivateMemeberByPublicMethod(), super.getPrivateMemeberByProtectedMethod());
        console.log('protected method:', super.getProtectedMemeberByPublicMethod(), super.getProtectedMemeberByProtectedMethod());
        console.log('*** conclusion: any members from super can be called by public/protected methods ***');
    }
...
class OverridenExampleClass extends ExampleClass {
    ...
    testSuper(): void {
        ...
        console.log('private method:', super.getPrivateMemeberByPublicMethod(), super.getPrivateMemeberByProtectedMethod());
        console.log('protected method:', super.getProtectedMemeberByPublicMethod(), super.getProtectedMemeberByProtectedMethod());
        console.log('*** duplicated conclusion: any members from super can be called by public/protected methods ***');
    }
...
const extendedExampleInstance = new ExtendedExampleClass('public2', 'private2', 'protected2');
...
const overridenExampleInstance = new OverridenExampleClass('public2', 'protected2');
